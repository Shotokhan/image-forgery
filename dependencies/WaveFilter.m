function [tc, coefVar]=WaveFilter(coef,NoiseVar)
% Model each detail wavelet coefficient as conditional Gaussian random
% variable and use several two-dimensional moving window to estimate the
...
%Output:
%   tc:            Attenuated wavelet coefficient
%   coefVar:      Finall estimated variances of each coefficient
