function result = batchOWO(inDir, outDir)
%batchOWO Batch process images using OWO
% RESULT = batchOWO(INDIR, OUTDIR) processes each file in INDIR
% using the function OWO.
%
% The following fields from the output of OWO are written with their
...
if(nargin<1)
    inDir = '/Users/francescosammarco/OneDrive/Università/ESM/Progetto/images1';
end
...
for imgInd = 1:numel(imds.Files)
    ...
    try
        ...
        % Process
        oneResult = struct();oneResult.output = imfiltbatch(im);
